...
class Ground(Wire):
    ...
    def draw(self, drbd):
        ...
        self.ids.append(drbd.canvas.create_line(xs, ys, xe, ye,
                                                tags="circuit"))
        self.ids.append(drbd.canvas.create_line(x1, y1, x2, y2,
                                                tags="circuit"))
        self.ids.append(drbd.canvas.create_line(x3, y3, x4, y4,
                                                tags="circuit"))
        self.ids.append(drbd.canvas.create_line(x5, y5, x6, y6,
                                                tags="circuit"))
        self.drawname(drbd)
        self.drawbbox(drbd)
